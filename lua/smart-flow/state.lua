...
---Saves the state in the global _G.SmartFlow.state object.
---
---@private
function state:save()
    log.debug("state.save", "saving state globally to _G.SmartFlow.state")

    _G.SmartFlow.state = self
end
...
---Whether the SmartFlow is enabled or not.
---
